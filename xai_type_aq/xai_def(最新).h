...
#define XAI_CHECK_TYPE_COUNT    8	//检测方法类型的数量

#define XAI_CHECK_TYPE_HARD		0	//检测方法类型-基本检测   模式1
#define XAI_CHECK_TYPE_SOFT		1	//检测方法类型-大异物     模式2
#define XAI_CHECK_TYPE_OTHERS	2	//检测方法类型-中异物     模式3
